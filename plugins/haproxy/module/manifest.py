MANIFEST={
 "name":"haproxy","title":"HAProxy","version":"1.0.0","type":"external","attr":["依赖","网络"],
 "description":"HTTP/TCP 反代与负载均衡 provider","proxy":"haproxy","provides":{"proxy":"haproxy"},
 "rproxy_module":"aups.modules.haproxy.api","capabilities":["status","show","apply","reload","sites","validate","logs","upstreams","tls","websocket","health_check","tcp","deploy_switch"],
