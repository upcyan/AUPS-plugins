...
MANIFEST = {
    ...
    "title": "安全加固",
    "version": "0.2.0",
    "description": "轻量主机安全加固：rkhunter 入侵检测、LMD 恶意软件扫描、YARA 规则订阅、fanotify 实时防护与 WAF 主动防御联动",
    "type": "external",
    "attr": "功能",
    "deploy": {"host": True},
    ...
    "api_paths": [
        ...
        "/api/cyansec/rt",
        "/api/cyansec/rt/events",
    ],
    "frontend_tabs": ["cyansec"],
    "modules": ["scanner", "subscribe", "rtguard"],
    "plugins": [
        {"id": "overview", "title": "安全概览",
         "description": "引擎状态、一键安装、快速扫描入口"},
        {"id": "rt", "title": "实时防护",
         "description": "fanotify 文件监听 + YARA 命中 + WAF 主动防御联动"},
        {"id": "scan", "title": "扫描",
